...
class MyThemes {
  ...
  static lightTheme(BuildContext context) {
    ...
    return ThemeData(
        ...
        textTheme: TextTheme(
          headline1:
              TextStyle(fontSize: 48.sp, fontWeight: FontWeight.w800, color: AppColors.black , height: isArabic ? 1.8 : 1),
          headline2:
              TextStyle(fontSize: 40.sp, fontWeight: FontWeight.w800, color: AppColors.black),
          headline3:
              TextStyle(fontSize: 34.sp, fontWeight: FontWeight.w600, color: AppColors.black),
          headline4: TextStyle(fontSize: 24.sp, fontWeight: FontWeight.w600, color: AppColors.black),
          headline5:
              TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, color: AppColors.black, height: isArabic ? 1.8 : 1),
          headline6:
              TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w500, color: AppColors.black, height: isArabic ? 1.8 : 1),
          bodyText1: TextStyle(
              color: Colors.black,
              fontSize: 20.sp,
          ...
          subtitle2: TextStyle(color: Colors.black, fontSize: 16.sp, fontWeight: FontWeight.w400),
          button: TextStyle(color: Colors.black, fontSize: 16.sp, fontWeight: FontWeight.w500),
          // caption used for textField error text:
          caption: TextStyle(color: Colors.black, fontSize: 14.sp, fontWeight: FontWeight.w400),
        ),
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            ...
            textStyle:
                TextStyle(fontSize: 18.sp, fontWeight: FontWeight.w500, fontFamily: fontFamily),
          ),
        ),
        ...
        dialogTheme: const DialogTheme(contentTextStyle: TextStyle(fontSize: 18, color: Colors.red)));
  }
  ...
  static darkTheme(BuildContext context) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyText1: TextStyle(color: Colors.white, fontSize: 20.sp, fontWeight: FontWeight.w500),
        // bodyText2 used for Texts :
        bodyText2: TextStyle(
            color: Colors.white,
            fontSize: 18.sp,
            fontWeight: FontWeight.w500,
            height: isArabic ? 1.8 : null),        // subtitle1 used for textField content and hint, ListTile title :
        subtitle1: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.w500),
        subtitle2: TextStyle(color: Colors.white, fontSize: 16.sp, fontWeight: FontWeight.w400),
        button: TextStyle(color: Colors.white, fontSize: 16.sp, fontWeight: FontWeight.w500),
        // caption used for textField error text:
        caption: TextStyle(color: Colors.white, fontSize: 14.sp, fontWeight: FontWeight.w400),
      ),
